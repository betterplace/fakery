...
Gem::Specification.new do |s|
  ...
  s.files = [".gitignore", ".rspec", "Gemfile", "LICENSE", "README.md", "Rakefile", "VERSION", "fakery.gemspec", "lib/fakery.rb", "lib/fakery/api.rb", "lib/fakery/api_error.rb", "lib/fakery/change.rb", "lib/fakery/fake.rb", "lib/fakery/fakery_error.rb", "lib/fakery/registry.rb", "lib/fakery/version.rb", "spec/change_spec.rb", "spec/spec_helper.rb"]
  ...
  s.test_files = ["spec/change_spec.rb", "spec/spec_helper.rb"]
